package com.tensquare.sms.qa.controller;
import java.util.Map;

import com.tensquare.sms.qa.client.BaseClient;
import com.tensquare.sms.qa.pojo.Problem;
import com.tensquare.sms.qa.service.ProblemService;
...
public class ProblemController {
	...
	//这个地方爆红是在当前的项目Spring容器中找BaseClient,但是当前使用的是微服务
	//是使用网络去Base模块中加载的BaseClient的一个实体
	@Autowired
