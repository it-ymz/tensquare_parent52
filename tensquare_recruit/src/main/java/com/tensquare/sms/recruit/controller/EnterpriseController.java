package com.tensquare.sms.recruit.controller;
import java.util.List;
import java.util.Map;

import com.tensquare.sms.recruit.pojo.Enterprise;
...
import com.tensquare.sms.recruit.service.EnterpriseService;
...
public class EnterpriseController {
	...
	//查询的是热门企业  method请求方式  = RequestMethod是前端发来请求的方式
